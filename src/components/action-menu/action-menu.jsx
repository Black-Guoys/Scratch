...
class ActionMenu extends React.Component {
    ...
    render () {
        ...
        // const className = this.props.className; 与上面相等
        // const moreButtons = this.props.moreButtons;
...
ActionMenu.propTypes = {
    ...
    moreButtons: PropTypes.arrayOf(PropTypes.shape({
        ...
        onClick: PropTypes.func, // Optional, "coming soon" if no callback provided 可选，如果未提供回拨，则为“即将到来”
        fileAccept: PropTypes.string, // Optional, only for file upload
        fileChange: PropTypes.func, // Optional, only for file upload可选，仅用于文件上载
