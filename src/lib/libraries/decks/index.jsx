...
// Animate a nameAnimate a name为名称设置动画
...
export default {
    ...
    'intro-move-sayhello': {
        name: (
            <FormattedMessage
                ...
                description="Name for the 'Getting Started' how-to“入门”操作方法的名称"
        ...
        steps: [{
            ...
            title: (
                <FormattedMessage
                    ...
                    description="Step name for 'Add a move block' step“添加移动块”步骤的步骤名称"
            ...
            title: (
                <FormattedMessage
                    ...
                    description="Step name for 'Add A Say Block' step“添加说块”步骤的步骤名称"
    ...
    'animate-a-name': {
        name: (
            <FormattedMessage
                ...
                description="Name for the 'Animate a Name' how-to动画名称”操作方法的名称"
        ...
        steps: [{
            ...
            title: (
                <FormattedMessage
                    ...
                    description="Step name for 'Pick a Letter Sprite' step选择一个字母步骤名称"
            ...
            title: (
                <FormattedMessage
                    ...
                    description="Step name for 'Play a Sound When Clicked' step“单击时播放声音”步骤的步骤名称"
            ...
            title: (
                <FormattedMessage
                    defaultMessage="Pick Another Letter Sprite再挑一个字母"
                    description="Step name for 'Pick Another Letter Sprite选择另一个字母雪碧”的步骤名称"
            ...
            title: (
                <FormattedMessage
                    ...
                    description="Step name for 'Change color' step“更改颜色”步骤的步骤名称"
            ...
            title: (
                <FormattedMessage
                    defaultMessage="Pick Another Letter Sprite & Make It Spin再挑一个字母雪碧，让它旋转"
            ...
            title: (
                <FormattedMessage
                    defaultMessage="Pick Another Letter Sprite & Make It Grow再选个字母让他变大"
    ...
    'Make-Music': {
        ...
        },
        {
            title: (
                <FormattedMessage
                    defaultMessage="Pick an Instrument Sprite 选择一个仪表精灵"
        ...
        },
        {
            title: (
                <FormattedMessage
                    defaultMessage="Play Sound When Clicked点击时候播放音乐"
        ...
        },
        {
            title: (
                <FormattedMessage
                    defaultMessage="Create a Song创造一个歌"
            ...
            title: (
                <FormattedMessage
                    defaultMessage="Choose a Drum & Make a Beat选择一个古 制作打击古"
            ...
            title: (
                <FormattedMessage
                    defaultMessage="Choose the Microphone Sprite & Surprise Beatbox选择麦克风精灵 惊喜的电子古"
    ...
    'Make-A-Game': {
        name: (
            <FormattedMessage
                defaultMessage="Make a Clicker Game制作一个点击游戏"
        ...
        },
        {
            title: (
                <FormattedMessage
                    defaultMessage="Pick A Sprite挑选精灵"
            ...
            title: (
                <FormattedMessage
                    defaultMessage="Create Score Variable创建分数变量"
            ...
            title: (
                <FormattedMessage
                    defaultMessage="When Clicked Increase Score单击时增加分数"
